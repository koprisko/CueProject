...
def stock_lookup(name):
    ...
    #data.encoding = 'utf-8'
    #data = data.text
    #data = data.replace("YAHOO.Finance.SymbolSuggest.ssCallback", "")
    #data = data.json()'
    for i in data:
        print(i)
...
def main():   
            #name = input("What stock do you want to look at?")
            #stock_lookup("NIKE")
