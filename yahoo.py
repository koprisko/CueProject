...
class Fetcher:
    ...
    def getData(self, events):
        ...
        #Request information from yahoo, return from csv using pandas
...
#data is a dataframe
#Use ticker, range of time, and then increment 
data = Fetcher('MSFT', [2012,1,1], [2015,1,1],'1d').getHistorical()
